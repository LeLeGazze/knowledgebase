 ...
 * @since 2023-05-05
 */
@Api(tags="知识浏览收藏评论api管理控制器")
@RestController
@RequestMapping("/api/knowledge/kbBasicUser")
public class ApiKbBasicUserController {
    @Autowired
     ...
     * @return
     */
    @CastleLog(operLocation="知识浏览收藏评论-api",operType = OperationTypeEnum.QUERY)
    @ApiOperation("知识浏览收藏评论分页展示")
    @GetMapping("/page")
    public RespBody<IPage<KbBasicUserDto>> pageKbBasicUser(KbBasicUserDto kbBasicUserDto, @RequestParam(required = false) Integer currentPage, @RequestParam(required = false)Integer size){
     ...
     * @return
     */
    @CastleLog(operLocation="知识浏览收藏评论-api",operType = OperationTypeEnum.INSERT)
     ...
     * @return
     */
    @CastleLog(operLocation="知识浏览收藏评论-api",operType = OperationTypeEnum.UPDATE)
    ...
    /**
     * 知识浏览收藏评论删除
     * @param ids 知识浏览收藏评论id集合
     * @return
     */
    @CastleLog(operLocation="知识浏览收藏评论-api",operType = OperationTypeEnum.DELETE)
    @ApiOperation("知识浏览收藏评论删除")
    @PostMapping("/delete")
    public RespBody<String> deleteKbBasicUser(@RequestBody List<Long> ids){
